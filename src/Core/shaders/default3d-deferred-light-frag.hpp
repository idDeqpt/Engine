#ifndef DEFAULT_3D_DEFERRED_LIGHT_FRAGMENT_SHADER_STRING_HPP
#define DEFAULT_3D_DEFERRED_LIGHT_FRAGMENT_SHADER_STRING_HPP

namespace eng::core::shader
{
	static const char* default3d_deferred_light_frag =R"(
#version 330 core
...
#endif //DEFAULT_3D_DEFERRED_LIGHT_FRAGMENT_SHADER_STRING_HPP
...
phy::Collider2D::Type phy::CircleCollider2D::getType()
{
	return Collider2D::Type::CIRCLE;
}
...
phy::CollisionData phy::CircleCollider2D::collideWithCircle(CircleCollider2D& other)
{
    ...
    // Точка контакта (на границе между окружностями)
    // Можно взять среднюю точку или точку на поверхности первой окружности
